...
class Pokemon(models.Model):
    ...
    previous_evolution = models.ForeignKey('self', verbose_name='из кого эволюционировал', on_delete=models.CASCADE, null=True, blank=True)
    next_evolution = models.ForeignKey('self', verbose_name='в кого эволюционирует', on_delete=models.CASCADE, null=True, blank=True, related_name='next_evo')
